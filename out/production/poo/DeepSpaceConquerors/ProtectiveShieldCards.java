 ...
 */
public class ProtectiveShieldCards extends ConstructionCards implements IRepairable, IImprovable {
	 ...
	 */
	public ProtectiveShieldCards(int price, int variableHealth) {
		super(price);
