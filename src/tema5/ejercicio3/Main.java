...
import tema5.ejercicio3.Personaje.Raza;
...
public class Main {
	 ...
	 * c1 = null;
	 *
	 * try { m1 = new Mago("Pablo", Raza.HUMANO, 12, 20, 80); m2 = new
	 * Mago("Gandalf", Raza.ENANO, 14, 19, 90); c1 = new Clerigo("Guzol", Raza.ELFO,
	 * 19, 17, 70, "Primux");
	 *
	 ...
	 *
	 * try { m1.aprendeHechizo("Suspensos maximos");
	 ...
	 * "Suspensos maximos"); System.out.println(m1); System.out.println(m2);
