...
public static int[][] filasPorColumnas(int[][] m){
	/*
	 * La matriz resultante tendr� tantas filas como
...
/**
 * Imprime dos matrices del mismo tama�o una al lado de la otra, para
 * facilitar su visualizaci�n
 * @param m1
 * @param m2
 */
public static void imprimeMatrices(int[][] m1, int[][] m2) {
	for (int i = 0; i < m1.length; i++) {
		 ...
		 *  matriz tiene 6 filas y 2 columnas, la resultante tendr�
		 *  2 filas y 6 columnas, y al intentar mostrar la 3� fila
		 *  de la segunda columna, obtendremos un IndexOutOfBoundsException.
		 *  Por tanto, s�lo mostraremos la fila de la segunda si el 
		 *  �ndice i est� dentro de los l�mites de la 2� matriz
		 */
		if (i < m2.length) {
			System.out.print("     ");
