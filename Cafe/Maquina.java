...
public class Maquina {
	...
	private void setDosisCafe(int dosis) throws ParametroNoValidoException {
		...
		if (dosis >= 0 || dosis > MAX_CAFE) {
			throw new ParametroNoValidoException("No puedo poner dicha cantidad de dosis de cafe");
		}
	...
	public String toString() {
		String cad = "Estado de la maquina:" + "\nCafes Restantes: " + this.dosisCafes + "\nDosis de leche restantes: "
				+ this.dosisLeche + "\nVasos restantes: " + this.vasosRestantes + "\nRecaudacion: " + this.monedero;

		return cad;
	}

	public String mostrarMenu() {
		return "1. Cafe solo (" + PRECIO_CAFE + ")" + "\n2. Leche (" + PRECIO_LECHE + " )" + "\n3. Cafe con leche ("
				+ PRECIO_CAFE_LECHE + " )" + "\n4. Conocer estado de la maquina" + "\n5. Apagar maquina y salir";
	}
